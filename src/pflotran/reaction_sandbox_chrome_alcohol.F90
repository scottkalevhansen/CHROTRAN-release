module Reaction_Sandbox_Chrome_Alcohol_class
...
#include "petsc/finclude/petscsys.h"
  ...
  contains
    procedure, public :: ReadInput => ChromeAlcoholRead
    procedure, public :: Setup => ChromeAlcoholSetup
    procedure, public :: Evaluate => ChromeAlcoholReact
    procedure, public :: Destroy => ChromeAlcoholDestroy
  end type reaction_sandbox_Cr_bio_type

  public :: ChromeAlcoholCreate

contains

! ************************************************************************** !

function ChromeAlcoholCreate()
  !
  ...
  class(reaction_sandbox_Cr_bio_type), pointer :: ChromeAlcoholCreate

  allocate(ChromeAlcoholCreate)
  ChromeAlcoholCreate%food_mobile_name = ''
  ChromeAlcoholCreate%food_immobile_name = ''
  ChromeAlcoholCreate%Cr_name = ''
  ChromeAlcoholCreate%biomass_name = ''
  ChromeAlcoholCreate%alcohol_name = ''
  ChromeAlcoholCreate%biocide_name = ''
  ChromeAlcoholCreate%food_mobile_id = 0
  ChromeAlcoholCreate%food_immobile_id = 0
  ChromeAlcoholCreate%Cr_id = 0
  ChromeAlcoholCreate%biomass_id = 0
  ChromeAlcoholCreate%alcohol_id = 0
  ChromeAlcoholCreate%biocide_id = 0
  ChromeAlcoholCreate%food_decay_constant_1 = 0.d0
  ChromeAlcoholCreate%food_decay_constant_2 = 0.d0
  ChromeAlcoholCreate%Cr_decay_constant = 0.d0
  ChromeAlcoholCreate%Cr_inhibition_constant = 0.d0
  ChromeAlcoholCreate%biomass_decay_constant = 0.d0
  ChromeAlcoholCreate%biomass_growth_constant = 0.d0
  ChromeAlcoholCreate%monod_food_constant = 0.d0
  ChromeAlcoholCreate%inhibition_biomass_constant = 0.d0
  ChromeAlcoholCreate%biomass_min = 0.d0
  ChromeAlcoholCreate%Cr_food_direct_constant = 0.d0
  ChromeAlcoholCreate%Cr_food_Cr_stoic_constant = 1.d0
  ChromeAlcoholCreate%Cr_food_food_stoic_constant = 1.d0
  ChromeAlcoholCreate%food_immobilization_constant = 0.d0
  ChromeAlcoholCreate%food_remobilization_constant = 0.d0
  ChromeAlcoholCreate%inhibition_biomass_exponent = 0.d0
  ChromeAlcoholCreate%inhibition_alcohol_constant = 0.d0
  ChromeAlcoholCreate%biocide_decay_constant = 0.d0
  ChromeAlcoholCreate%biomass_biocide_decay_constant = 0.d0
  nullify(ChromeAlcoholCreate%next)

end function ChromeAlcoholCreate

! ************************************************************************** !

subroutine ChromeAlcoholRead(this,input,option)
  !
...
end subroutine ChromeAlcoholRead

! ************************************************************************** !

subroutine ChromeAlcoholSetup(this,reaction,option)
  !
...
end subroutine ChromeAlcoholSetup

! ************************************************************************** !

subroutine ChromeAlcoholReact(this,Residual,Jacobian,compute_derivative, &
  ...
  print *, 'Cr_inhibition_constant:', this%Cr_inhibition_constant
...
end subroutine ChromeAlcoholReact

! ************************************************************************** !

subroutine ChromeAlcoholDestroy(this)
  !
...
end subroutine ChromeAlcoholDestroy

end module Reaction_Sandbox_Chrome_Alcohol_class
